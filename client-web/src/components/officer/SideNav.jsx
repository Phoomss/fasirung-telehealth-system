...
import { Calendar, ClipboardList, FileText, MessageSquare, HelpCircle, CheckSquare, User, LogOut, X } from 'lucide-react'
                ...
                <div className="flex h-full flex-col gap-4 px-4 py-5">
                    ...
                    <nav className="flex-1 overflow-y-auto" onClick={() => { if (window.innerWidth < 1024) onClose(); }}>
                        <ul className="space-y-1">
                            ...
                            <li><NavLink to='/officer/reservation' className={linkClass}><Calendar className="h-4.5 w-4.5 shrink-0" /><span>จัดการการจองคิว</span></NavLink></li>
                            <li><NavLink to='/officer/consult' className={linkClass}><ClipboardList className="h-4.5 w-4.5 shrink-0" /><span>จัดการเคสคนเข้าปรึกษา</span></NavLink></li>
                            <li className={sectionClass}>จัดการคอนเทนท์</li>
                            <li><NavLink to='/officer/content' className={linkClass}><FileText className="h-4.5 w-4.5 shrink-0" /><span>เนื้อหาคอนเทนท์</span></NavLink></li>
                            <li><NavLink to='/officer/assessment/response' className={linkClass}><MessageSquare className="h-4.5 w-4.5 shrink-0" /><span>รายการตอบกลับ</span></NavLink></li>
                            <li><NavLink to='/officer/assessment/question' className={linkClass}><HelpCircle className="h-4.5 w-4.5 shrink-0" /><span>จัดการคำถาม</span></NavLink></li>
                            <li><NavLink to='/officer/assessment/answer' className={linkClass}><CheckSquare className="h-4.5 w-4.5 shrink-0" /><span>จัดการคำตอบ</span></NavLink></li>
                            <li className={sectionClass}>จัดการข้อมูล</li>
                            <li><NavLink to='/officer/profile' className={linkClass}><User className="h-4.5 w-4.5 shrink-0" /><span>ข้อมูลส่วนตัว</span></NavLink></li>
